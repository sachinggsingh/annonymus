...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3  py-5 gap-4",
        className
      )}
    >
      {items.map((item, idx) => (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-8 overflow-hidden bg-white border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20 min-h-[300px]",
        className
      )}
    >
